...
class AuthenticationUseCaseTest {
    ...
    void testRegisterSuccess() {
        ...
        when(userRepositoryPort.getUserById(user.getId())).thenReturn(null);
        ...
        verify(userRepositoryPort).getUserById(user.getId());
    ...
    void testRegisterEmailAlreadyExists() {
        ...
        verify(userRepositoryPort).getUserByEmail(user.getEmail());
        verify(userRepositoryPort, never()).getUserById(any());
    ...
    void testRegisterIdDocumentAlreadyExists() {
        ...
        when(userRepositoryPort.getUserByEmail(user.getEmail())).thenReturn(user);
        when(userRepositoryPort.getUserById(user.getId())).thenReturn(user);
